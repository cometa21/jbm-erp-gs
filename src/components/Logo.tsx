...
export function Logo({ className = '', variant = 'full', size = 'md' }: LogoProps) {
  ...
  if (variant === 'mono') {
    // Thermal printer monochrome logo (clean grayscale matching ticket-jbm.jpeg)
    return (
      <div className={`flex flex-col items-center justify-center text-center ${className}`}>
        ...
        <div className="font-extrabold text-[15px] tracking-wider text-black font-sans leading-tight mt-0.5">
          JBM CÍTRICOS
        </div>
        <div className="font-bold text-[11px] tracking-[0.25em] text-neutral-800 font-sans">
          BARRAGÁN
        </div>
      </div>
    );
  ...
  if (variant === 'compact') {
    return (
      <div className={`flex items-center gap-2.5 ${className}`}>
        <div className="relative w-10 h-10 flex-shrink-0 bg-gradient-to-br from-emerald-600 to-emerald-800 rounded-xl flex items-center justify-center shadow-md shadow-emerald-950/20 border border-emerald-500/30">
  ...
  // Full color logo matching logo-jbm-B7s-mj7h-removebg-preview.png
  return (
    <div className={`flex flex-col items-center justify-center text-center select-none ${sizeMap[size]} ${className}`}>
      ...
      >
        <defs>
          {/* Gold Gradient for JBM typography */}
        ...
        <g transform="translate(150, 10)">
          <path
            d="M18 42 C6 24 16 4 36 0 C46 16 46 36 34 44 C26 48 20 46 18 42 Z"
            fill="url(#leafGrad1)"
          />
          {/* Leaf vein */}
        ...
        <g transform="translate(178, 14)">
          <path
            d="M8 32 C18 14 36 18 44 30 C34 40 18 40 8 32 Z"
            fill="url(#leafGrad2)"
          />
        ...
        {/* --- CITRUS DOME --- */}
        {/* Outer dark green dome */}
        <path
          d="M72 120 C72 58 112 36 160 36 C208 36 248 58 248 120 Z"
          fill="url(#limeSkin)"
        />

        {/* Inner pulp hemisphere */}
        <path
          d="M92 120 C92 78 120 52 160 52 C200 52 228 78 228 120 Z"
          fill="url(#pulpGrad)"
        />

        {/* Pulp vesicles / texture patterns */}
        <g opacity="0.65" stroke="#15803D" strokeWidth="1.2" fill="#86EFAC">
          {/* Top row */}
          <ellipse cx="160" cy="74" rx="8" ry="12" transform="rotate(-5 160 74)" />
          <ellipse cx="140" cy="82" rx="7" ry="11" transform="rotate(-25 140 82)" />
          <ellipse cx="180" cy="82" rx="7" ry="11" transform="rotate(25 180 82)" />
          
          {/* Middle row */}
          <ellipse cx="122" cy="98" rx="8" ry="12" transform="rotate(-40 122 98)" />
          <ellipse cx="145" cy="100" rx="7" ry="11" transform="rotate(-15 145 100)" />
          <ellipse cx="160" cy="98" rx="8" ry="13" />
          <ellipse cx="175" cy="100" rx="7" ry="11" transform="rotate(15 175 100)" />
          <ellipse cx="198" cy="98" rx="8" ry="12" transform="rotate(40 198 98)" />

          {/* Bottom row */}
          <ellipse cx="108" cy="115" rx="7" ry="8" transform="rotate(-60 108 115)" />
          <ellipse cx="132" cy="115" rx="8" ry="9" transform="rotate(-20 132 115)" />
          <ellipse cx="160" cy="116" rx="9" ry="9" />
          <ellipse cx="188" cy="115" rx="8" ry="9" transform="rotate(20 188 115)" />
          <ellipse cx="212" cy="115" rx="7" ry="8" transform="rotate(60 212 115)" />
        </g>
